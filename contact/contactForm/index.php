    ...
    <?php else: ?>
        ...
        <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" enctype="application/x-www-form-urlencoded" id="contact-form" class="form-horizontal" method="post">
            <div class="form-group">
                <label for="form-name" class="col-md-2 control-label"><?php echo $config->get('fields.name'); ?></label>
                <div class="col-md-10">
                    <input type="text" class="form-control" id="form-name" name="form-name" placeholder="<?php echo $config->get('fields.name'); ?>" required>
                </div>
            </div>
            <div class="form-group">
                <label for="form-email" class="col-md-2 control-label"><?php echo $config->get('fields.email'); ?></label>
                <div class="col-md-10">
            ...
            <div class="form-group">
                <label for="form-subject" class="col-md-2 control-label"><?php echo $config->get('fields.subject'); ?></label>
                <div class="col-md-10">
            ...
            <div class="form-group">
                <div class="col-md-10">
                    <button type="submit" class="btn btn-info btn-lg"><?php echo $config->get('fields.btn-send'); ?></button>
                </div>
            </div>
        </form>
